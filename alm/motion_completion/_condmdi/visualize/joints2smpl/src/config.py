...
_RUNTIME_PATHS = get_motion_paths()
SMPL_MODEL_DIR = str(_RUNTIME_PATHS.body_model_root)
GMM_MODEL_DIR = str(_RUNTIME_PATHS.smplify_resources)
SMPL_MEAN_FILE = str(
    _RUNTIME_PATHS.smplify_resources / "neutral_smpl_mean_params.h5"
)
# for collsion 
Part_Seg_DIR = str(_RUNTIME_PATHS.smplify_resources / "smplx_parts_segm.pkl")
