...
from alm.motion_completion._condmdi.data_loaders.humanml.motion_loaders.comp_v6_model_dataset import (CompMDMGeneratedDataset,
                                                                       CompMDMGeneratedDatasetCondition,
                                                                       CompMDMGeneratedDatasetInpainting)
from alm.motion_completion._condmdi.data_loaders.humanml.motion_loaders.comp_v6_model_dataset_condmdi import CompMDMGeneratedDatasetCondMDI
...
def get_motion_loader(opt_path, batch_size, ground_truth_dataset,
    ...
    if opt.dataset_name == 't2m' or opt.dataset_name == 'kit':
        w_vectorizer = WordVectorizer(
            str(get_motion_paths().glove_root), 'our_vab'
        )
    else:
