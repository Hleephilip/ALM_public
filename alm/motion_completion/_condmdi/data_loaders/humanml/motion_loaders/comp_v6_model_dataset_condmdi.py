...
from alm.motion_completion._condmdi.data_loaders.humanml.networks.modules import *
from alm.motion_completion._condmdi.data_loaders.humanml.networks.trainers import CompTrainerV6
...
from alm.motion_completion._condmdi.data_loaders.humanml.data.dataset import abs3d_to_rel, sample_to_motion, rel_to_abs3d
from alm.motion_completion._condmdi.data_loaders.humanml.scripts.motion_process import recover_from_ric
from alm.motion_completion._condmdi.data_loaders.humanml.utils.metrics import calculate_skating_ratio
from alm.motion_completion._condmdi.sample.gmd.condition import (cond_fn_key_location, get_target_from_kframes, get_target_and_inpt_from_kframes_batch,
...
from alm.motion_completion._condmdi.utils.editing_util import get_keyframes_mask
...
class CompMDMGeneratedDatasetCondMDI(Dataset):
    ...
    def __init__(self, model_dict, diffusion_dict, dataloader, mm_num_samples, mm_num_repeats,
        ...
        with torch.no_grad():
            for i, (motion, model_kwargs) in tqdm(enumerate(dataloader)):
                ...
                elif self.args.imputate or self.args.reconstruction_guidance or self.args.alm:
                    # Editing arguments:
    ...
    def set_inference_editing_args(self, model_kwargs, input_motions):
        ...
        model_kwargs['y']['alm'] = self.args.alm
        ...
        model_kwargs['y']['w_1'] = self.args.w_1
        model_kwargs['y']['w_2'] = self.args.w_2
