...
from alm.motion_completion._condmdi.data_loaders.tensors import collate as all_collate
from alm.motion_completion._condmdi.data_loaders.tensors import t2m_collate, amass_collate
...
def get_dataset_class(name):
    if name == "amass":
        from alm.motion_completion._condmdi.data_loaders.amass.data.dataset import AMASS
        return AMASS
    elif name == "uestc":
        ...
        from alm.motion_completion._condmdi.data_loaders.humanml.data.dataset import HumanML3D
        return HumanML3D
    elif name == "kit":
        from alm.motion_completion._condmdi.data_loaders.humanml.data.dataset import KIT
        return KIT
    else:
...
def get_collate_fn(name, hml_mode='train'):
    if hml_mode == 'gt':
        from alm.motion_completion._condmdi.data_loaders.humanml.data.dataset import collate_fn as t2m_eval_collate
