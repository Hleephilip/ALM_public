...
import numpy as np
import torch
from alm.motion_completion._condmdi.utils.parser_util import cond_synt_args
from alm.motion_completion._condmdi.utils.model_util import create_model_and_diffusion, load_saved_model
...
from alm.motion_completion._condmdi.data_loaders.humanml.scripts.motion_process import recover_from_ric
from alm.motion_completion._condmdi.data_loaders import humanml_utils
import alm.motion_completion._condmdi.data_loaders.humanml.utils.paramUtil as paramUtil
from alm.motion_completion._condmdi.data_loaders.humanml.utils.plot_script import plot_3d_motion
import shutil

import json
from alm.motion_completion._condmdi.utils.editing_util import get_keyframes_mask, load_fixed_dataset
...
def main():
    ...
    assert args.alm, 'This entry point runs ALM motion completion; pass --alm.'
    ...
    if out_path == '':
        ...
        model_results_path = os.path.join(
            get_motion_paths().output_root, checkpoint_name
        )
        out_path = os.path.join(model_results_path,
                                'edit_{}_alm_{}_seed{}_w_1={}_w_2={}'.format(
                                    niter, args.edit_mode, args.seed,
                                    args.w_1, args.w_2))
    ...
    model_kwargs['y']['w_1'] = args.w_1
    model_kwargs['y']['w_2'] = args.w_2
