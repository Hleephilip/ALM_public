...
from alm.motion_completion._condmdi.utils.hfargparse import HfArgumentParser
...
class CondSyntOptions:
    edit_mode: str = field(
        ...
        metadata={
            "choices": ['lower_body', 'benchmark_sparse', 'middle_half', 'first_half', 'last_half', 'benchmark_clip', 'pelvis', 'right_wrist', 'random_frames', 'random_joints', 'random', 'gmd_keyframes', 'uncond', 'pelvis_vr', 'pelvis_feet'],
    ...
    alm: bool = field(
        default=False, metadata={
            "help": "Use ALM for motion completion."
        })
